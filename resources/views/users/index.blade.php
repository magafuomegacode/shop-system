...
@section('content')
        ...
        <div class="fade-in-up d-2 bg-gradient-to-br from-green-500/20 via-emerald-500/20 to-teal-500/20 border border-green-500/40 rounded-2xl p-5 mb-6 relative overflow-hidden shadow-2xl">
            ...
            <div class="relative z-10">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <div class="bg-blue-900/40 backdrop-blur rounded-xl p-3 border border-blue-700/50">
                        <p class="text-blue-200 text-xs">Full Name</p>
                        <p class="text-white font-semibold mt-1">{{ $creds['full_name'] }}</p>
                    </div>
                    <div class="bg-blue-900/40 backdrop-blur rounded-xl p-3 border border-blue-700/50">
                        <p class="text-blue-200 text-xs">Role</p>
                        <p class="text-white font-semibold mt-1 capitalize">{{ $creds['role'] }}</p>
                    </div>
                    <div class="bg-blue-900/40 backdrop-blur rounded-xl p-3 border border-blue-700/50">
                        <p class="text-blue-200 text-xs">Username</p>
                        <div class="flex items-center justify-between gap-2 mt-1">
                            ...
                            <button type="button" onclick="copyText(this, '{{ $creds['username'] }}')"
                                    class="text-cyan-400 hover:text-cyan-300 text-xs font-semibold">Copy</button>
                        </div>
                    </div>
                    <div class="bg-blue-900/40 backdrop-blur rounded-xl p-3 border border-blue-700/50">
                        <p class="text-blue-200 text-xs">Password</p>
                        <div class="flex items-center justify-between gap-2 mt-1">
            ...
            @foreach($users as $user)
                <div class="fade-in-up bg-gradient-to-br from-blue-950 via-blue-900 to-blue-950 rounded-2xl p-4 hover:bg-blue-800/50 transition shadow-2xl border border-blue-700/50">
                    <div class="flex items-center gap-3">
                        ...
                        {{-- Avatar --}}
                        <div class="w-12 h-12 rounded-xl bg-gradient-to-br from-blue-500 to-cyan-500 flex items-center justify-center text-white font-bold text-lg flex-shrink-0 shadow-lg">
    ...
    @else
        <div class="bg-gradient-to-br from-blue-950 via-blue-900 to-blue-950 rounded-2xl p-10 text-center shadow-2xl border border-blue-700/50">
            ...
            <p class="text-blue-100 text-sm font-medium">No users yet</p>
            <a href="{{ route('users.create') }}" class="inline-block mt-4 text-cyan-400 hover:text-cyan-300 text-sm font-bold">
                Add your first user →
            </a>
        </div>
    @endif
