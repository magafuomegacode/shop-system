...
@section('content')
    ...
    <form method="POST" action="{{ route('users.store') }}"
        ...
        <div>
            <label class="block text-xs font-semibold text-stone-300 mb-2">Role</label>
        ...
        <div>
            ...
            <p class="text-stone-400/70 text-xs mt-1">
        ...
        {{-- Email --}}
        <div>
            <label for="email" class="block text-xs font-semibold text-stone-300 mb-2">Email (optional)</label>
        ...
        {{-- Phone --}}
        <div>
            <label for="phone" class="block text-xs font-semibold text-stone-300 mb-2">Phone (optional)</label>
        ...
        @if(auth()->user()->isOwner())
            <div class="bg-green-500/20 border border-green-500/40 text-green-200 px-4 py-3 rounded-xl text-xs sm:text-sm flex items-start gap-2">
                ...
                <div>
                    ...
                    <p class="text-green-200/80 mt-0.5">This cashier will be able to sell from <strong>all stores</strong> in your shop.</p>
                </div>
            </div>
        @endif
