...
@section('content')
    ...
    <div class="bg-gradient-to-br from-stone-800 via-stone-700 to-stone-800 rounded-2xl p-6 mb-4 shadow-2xl border border-stone-600/50">
        ...
        <div class="grid grid-cols-2 gap-3">
            <div class="bg-stone-800/60 backdrop-blur rounded-xl p-4 border border-stone-600/50">
                <p class="text-stone-300 text-xs">Cashier</p>
                <p class="text-white font-semibold mt-1">
                    {{ $sale->cashier->full_name ?? 'Unknown' }}
                </p>
            </div>
            <div class="bg-stone-800/60 backdrop-blur rounded-xl p-4 border border-stone-600/50">
                <p class="text-stone-300 text-xs">Payment</p>
            ...
            @if($sale->customer_name)
                <div class="bg-stone-800/60 backdrop-blur rounded-xl p-4 col-span-2 border border-stone-600/50">
                    <p class="text-stone-300 text-xs">Customer</p>
    ...
    <div class="bg-gradient-to-br from-stone-800 via-stone-700 to-stone-800 rounded-2xl p-6 mb-4 shadow-2xl border border-stone-600/50">
        ...
        <div class="space-y-2">
            @foreach($sale->items as $item)
                <div class="flex items-center justify-between py-3 px-3 rounded-xl bg-stone-800/60 border border-stone-600/50">
    ...
    <div class="bg-gradient-to-br from-stone-800 via-stone-700 to-stone-800 rounded-2xl p-6 mb-4 shadow-2xl border border-stone-600/50">
        ...
        <div class="space-y-2 text-sm">
            ...
            @endif
            <div class="flex justify-between text-lg font-bold border-t border-stone-600/50 pt-3 mt-3">
    ...
    <div class="flex gap-3">
        <a href="{{ route('pos.receipt', $sale->id) }}"
           target="_blank"
           class="flex-1 bg-gradient-to-br from-yellow-600 to-lime-600 hover:from-yellow-700 hover:to-lime-700 text-white font-semibold py-3 rounded-xl transition shadow-lg text-center">
            View Receipt
        </a>
        <a href="{{ route('sales.index') }}"
           class="px-5 py-3 rounded-xl bg-stone-800/60 hover:bg-stone-700/60 border border-stone-600/50 text-white text-sm font-medium transition">
            Back
        </a>
    </div>
