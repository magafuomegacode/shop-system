...
@section('content')
    ...
    <div class="grid grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 mb-6">
        ...
        <div class="fade-in-up d-4 bg-gradient-to-br from-blue-950 via-blue-900 to-blue-950 rounded-2xl p-4 sm:p-5 col-span-2 lg:col-span-1 shadow-2xl border border-blue-700/50">
            <div class="w-10 h-10 rounded-xl bg-gradient-to-br from-blue-500 to-cyan-500 flex items-center justify-center shadow-lg">
                <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                    <path stroke-linecap="round" stroke-linejoin="round"
